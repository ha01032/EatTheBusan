...
<div id="content">
	...
	<div class="food_nav_2">
		...
		<div class="couponNav">
			...
			<div id="inner" class="couponList" style="cursor:pointer;" onclick="location.href='${root}/food/read.go?foodCode=${couponDto.foodCode}'">
				<div>
					<img alt="쿠폰 이미지" src="/resources/ftp/${couponDto.imageName}" onerror="this.src='${root}/resources/css/noimage.jpg'"> 
					<span>${couponDto.couponName}</span>
				</div>
				<div>
				...
				for (var i = 0; i < data.length; i++) {
					...
					// onclick='location.href=\""+url+"\"'>"; -> 해당 foodcode 음식점으로 이동
						cont += "<div>";
							...
							// 이미지 없을때
							cont += "<img alt='음식 이미지' src='/resources/ftp/"+data[i].imageName+"' onerror='this.src=\""+err+"\"'>";
						cont += "</div>";
						cont += "<div>";
							// 음식점 등록할 시 작성한 이름
