					...
					<div class="eat_2">
						...
						<c:forEach var="couponDto" items="${couponDtoList}" varStatus="status" >
							<div class="cp_mySlides fade">
								...
								<img alt="쿠폰이미지" src="/resources/ftp/${couponDto.imageName}" onerror="this.src='${root}/resources/css/noimage.jpg'">
									...
									<a href="javascript:void(0)" class="reviewInfoClick" >
										...
										<div class="reviewImg">
											...
											<c:forEach var="imgList" items="${img}">
												<img src="/resources/ftp/${imgList}" alt="이미지" onerror="this.src='${root}/resources/css/noimage.jpg'"/>
												<!-- 
			...
			<div class="img">
				<c:choose>
					<c:when test="${foodDto.foodStatus == 'Y'}">
						<img src="/resources/ftp/${imageDto.imageName}" alt="이미지"
							 onerror="this.src='${root}/resources/css/noimage.jpg'" />
					</c:when>
