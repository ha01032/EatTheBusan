	...
	<div id="content_mypage">
		<div class="myPage">
			<div class="title_mypage">
				<span><strong style="color: #309cef;">${foodName}</strong>에 대한 솔직한 리뷰를 써주세요.</span>
			</div>
			<div class="nav_1">
			<form action="${root}/review/updateOk.go" method="POST"	enctype="multipart/form-data" onsubmit="return reviewUpForm(this)">
				...
				<input type="hidden" name="foodCode" value="${food}" /> 
				<input type="hidden" name="memberCode" value="${member}" />
						...
						<table>
							<tr>
								<c:forEach var="imageDto" items="${listImage}">			
									...
									<td id="${tdId}" style="text-align: center;"><img src="/static/ftp/${imageDto.imageName}"
										alt="image" style="width: 100px; height: 100px;" onerror="this.src='${root}/static/css/noimage.jpg'"/><br />
