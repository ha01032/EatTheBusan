...
.nav_1 > input {
    ...
    margin-left: 34px;
    border: none;
	border-bottom: 2px solid #309cef;
}
...
.close:hover, .close:focus {
	...
	<div id="header">
		<div class="nav_1">
			<a href="${root}/"><span>E</span><span>A</span><span>T</span>          <span>T</span><span>H</span><span>E</span>          <span>B</span><span>U</span><span>S</span><span>A</span><span>N</span></a>
	...
	<div id="myModal" class="modal">
		<div id="content_main">
			...
			<div class="login">
				<img alt="로고" src="${root}/static/css/login.png">
