...
<%-- <link rel="stylesheet" href="${root}/static/css/admin/review.css"/> --%>
<style type="text/css">
* {
	margin: 0;
	padding: 0;
	...
	$.ajax({
		...
		success:function(data){
			...
			for(let i = 0; i<data.listImage.length; i++){				
				$("#imgWrapper").append("<img src='/static/ftp/"+data.listImage[i].imageName+"\' alt='"+data.listImage[i].imageName+"' style='width:150px; height:150px' />");
			}
		},
