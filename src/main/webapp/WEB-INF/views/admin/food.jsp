...
<script src="${root}/static/javascript/food/food.js"></script>
<script src="${root}/static/jquery/jquery-3.4.1.js"></script>
<%-- <link rel="stylesheet" href="${root}/static/css/admin/food.css" /> --%>
<style type="text/css">
* {
	margin: 0;
	padding: 0;
				...
				<div class="food">		
					...
					<div>
						...
						<select name="foodArea">
							<option value="남구/수영구">남구/수영구</option>
							<option value="해운대/기장">해운대/기장</option>
							<option value="래/연제">동래/연제</option>
							<option value="부산진/동구">부산진/동구</option>
							<option value="금정구/북구">금정구/북구</option>
							<option value="영도구/중구">영도/중구</option>
							<option value="사상/사하/서구">사상/사하/서구</option>
							<option value="강서">강서</option>
							<option value="김해/양산">김해/양산</option>
					...
					<div>
						<span>*대표이미지</span>
						<input type="file" name="imgFile" accept="${root}/static/ftp/*"/>
					</div>
					<div>
						<span>*음식점소개</span>
				...
				<div class="food">
					...
					<div>
						...
						<select name="foodArea" id="foodArea">
							<option value="남구/수영구">남구/수영구</option>
							<option value="해운대/기장">해운대/기장</option>
							<option value="동래/연제">동래/연제</option>
							<option value="부산진/동구">부산진/동구</option>
							<option value="금정구/북구">금정구/북구</option>
							<option value="영도구/중구">영도구/중구</option>
							<option value="사상/사하/서구">사상/사하/서구</option>
							<option value="강서">강서</option>
							<option value="김해/양산">김해/양산</option>
							<option value="거제">거제</option>
	...
	$.ajax({
		...
		success:function(data){
			...
			if(data.imageName != null){
				$("#imgWrapper").append("<img src='/static/ftp/"+data.imageName+"\' alt='"+data.imageName+"' style='width:150px; height:150px' />");
