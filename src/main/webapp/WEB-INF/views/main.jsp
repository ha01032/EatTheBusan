...
#img_wrapper {
  background-image: url(${root}/static/css/pusan.jpg);
  height: 40vh;
...
.con_3 > div:first-child {
	border-bottom: solid 2px #309cef;
	font-size: 23px;
}
		...
		<div id="section_container">
			<div class="con_2">
				<div class="searchKind" onclick="searchKind('한식')">
					<img alt="" src="${root}/static/css/icons8-rice-bowl-100.png">
					<span>한식</span>
				</div>
				<div class="searchKind" onclick="searchKind('중식')">
					<img alt="" src="${root}/static/css/icons8-noodles-100.png">
					<span>중식</span>
				</div>
				<div class="searchKind" onclick="searchKind('일식')">
					<img alt="" src="${root}/static/css/icons8-sushi-100.png">
					<span>일식</span>
				</div>
				<div class="searchKind" onclick="searchKind('양식')">
					<img alt="" src="${root}/static/css/icons8-hamburger-100.png">
					<span>양식</span>
				</div>
				<div class="searchKind" onclick="searchKind('카페')">
					<img alt="" src="${root}/static/css/icons8-cafe-100.png">
					<span>카페</span>
				</div>
				<div class="searchKind" onclick="searchKind('기타')">
					<img alt="" src="${root}/static/css/icons8-food-cart-100.png">
					<span>기타</span>
				</div>
			</div>
			<div class="con_3">
		...
		success : function(data) {
			...
			for (var i = 0; i < data.length; i++) {
				...
				cont += "<div style='cursor:pointer;' onclick='location.href=\""+url+"\"'>";
					...
					cont += "<img alt='음식 이미지' src='"+root+"/static/ftp/"+data[i].imageName+"' onerror='this.src=\""+err+"\"'>";
