...
import com.java.naver.NaverLoginManager;
...
public class Membercontroller {
	...
	public ModelAndView callback(HttpServletRequest request, HttpServletResponse response,
			@RequestParam Map<String, Object> data) throws IOException {
		ModelAndView mav = new ModelAndView();
	...
	// 내가 등록한 식당 삭제
	@RequestMapping(value = "/member/myFoodDel.go", method = RequestMethod.GET)
